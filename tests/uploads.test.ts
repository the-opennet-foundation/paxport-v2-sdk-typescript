import fs from 'fs';
import type { ResponseLike } from 'paxport-v2-sdk/internal/to-file';
import { toFile } from 'paxport-v2-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('paxport-v2-sdk/core/uploads');
    await expect(
