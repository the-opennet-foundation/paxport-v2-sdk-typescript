...
describe('resource reward', () => {
  ...
  test.skip('claimReward', async () => {
    const responsePromise = client.affiliate.reward.claimReward('id');
  ...
  test.skip('listRewards', async () => {
    const responsePromise = client.affiliate.reward.listRewards();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listRewards: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.affiliate.reward.listRewards(
        {
          filter: 'filter',
          page: 0,
          perPage: 0,
